...
public class StudentDatabase {
    public static Student studentSupplier = () -> new Student("Adam", 2, 3.6, "male", Arrays.asList("swimming", "basketball", "volleyball"), 11);       
    public static List<Student> getAllStudents() {
        ...
        Student student6 = new Student("James", 4, 3.9, "male", Arrays.asList("swimming", "basketball", "football", "baseball"), 14);
